...
import { register, login, userLogOut, refreshAccessToken, updateAccount, removeUserAccount, fetchUsers, fetchUser } from '../../services/authService/auth.service';
...
router.post('/login', authToken, schemaValidator("/auth/login"), login);
